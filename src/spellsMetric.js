module.exports = {  
  ...
  "SPELLS" : {
    ...
    "gust": {
      ...
      "slotLevel": "cantrip",
      "school": "Transmutation cantrip",
      "shortDescription": "Control the air to create one of the following effects at a point within range: One medium or smaller creature that you choose must succeed on a Strength save or be pushed up to 1.5 meters away from you. Create a small blast of air able to move one object that is neither held nor carried and that weighs no more than 5 pounds. The object is pushed up to 3 meters away. Create a harmless sensory affect using air, such as rustling some jimmies.",
      "longDescription": "You seize the air and compel it to create one of the following effects at a point you can see within range:  One Medium or smaller creature that you choose must succeed on a Strength saving throw or be pushed up to 1.5 meters away from you.  You create a small blast of air capable of moving one object that is neither held nor carried and that weighs no more than 5 pounds. The object is pushed up to 3 meters away from you. It isn't pushed with enough force to cause damage.  You create a harmless sensory affect using air, such as causing leaves to rustle, wind to slam shutters shut, or your clothing to ripple in a breeze.",
    ...
    "levitate": {
      ...
      "slotLevel": "2",
      "school": "Transmutation",
      "shortDescription": "Needs concentration. One creature or object you can see within range rises up to 6 meters and remains suspended there for the duration. A target can weigh no more than 500 pounds. An unwilling creature must succeed a Constitution save or be levitated. On your next turn you can use your action to  change the altitude by up to 6 meters in either direction, if you are the target you can use your movement.",
      "longDescription": "One creature or object of your choice that you can see within range rises vertically, up to 6 meters, and remains suspended there for the duration. The spell can levitate a target that weighs up to 500 pounds. An unwilling creature that succeeds on a Constitution saving throw is unaffected. The target can move only by pushing or pulling against a fixed object or surface within reach (such as a wall or a ceiling), which allows it to move as if it were climbing. You can change the target's altitude by up to 6 meters in either direction on your turn. If you are the target, you can move up or down as part of your move. Otherwise, you can use your action to move the target, which must remain within the spell's range. When the spell ends, the target floats gently to the ground if it is still aloft.",
    ...
    "tenser's floating disk ": {
      ...
      "slotLevel": "1",
      "school": "Conjuration Ritual",
      "shortDescription": "Create a 1 meter diameter disk that follows you around and can hold 500 lbs.",
    ...
    "mage hand": {
      ...
      "class": "Bard, ",
      "shortDescription": "Create a floating hand that you can control with your action. It must stay within 9 meters of you. It can't attack, activate magic items, or carry more than 10 lbs.",
      "longDescription": "A spectral, floating hand appears at a point you choose within range. The hand lasts for the duration or until you dismiss it as an action. The hand vanishes if it is ever m ore than 9 meters away from you or if you cast this spell again. You can use your action to control the hand. You can use the hand to manipulate an object, open an unlocked door or container, stow or retrieve an item from an open container, or pour the contents out of a vial. You can move the hand up to 9 meters each time you use it. The hand can't attack, activate magic items, or carry more than 10 pounds.",
    ...
    "catapult": {
      ...
      "slotLevel": "1",
      "school": "Transmutation",
      "shortDescription": "Launch one object weighing 1 to 5 pounds within 46 meter that isn't being worn or carried up to 27 meter in a straight line. Struck objects or creatures that faile a Dexterity save take 3d8 bludgeoning damage.",
