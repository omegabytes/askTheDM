...
"move earth": {
  ...
  "speak with plants": {
    ...
    "longDescription": "You imbue plants within 30 feet of you with limited sentience and animation, giving them the ability to communicate with you and follow your simple commands. You can question plants about events in the spell’s area within the past day, gaining information about creatures that have passed, weather, and other circumstances. You can also turn difficult terrain caused by plant growth (such as thickets and undergrowth) into ordinary terrain that lasts for the duration. Or you can turn ordinary terrain where plants are present into difficult terrain that lasts for the duration, causing vines and branches to hinder pursuers, for example. Plants might be able to perform other tasks on your behalf, at the D. M.’s discretion. The spell doesn’t enable plants to uproot themselves and move about, but they can freely move branches, tendrils, and stalks. If a plant creature is in the area, you can communicate with it as if you shared a common language, but you gain no magical ability to influence it. This spell can cause the plants created by the entangle spell to release a restrained creature."
  }, 
  "alter self": {
  ...
  "polymorph": {
    ...
    "duration": "Concentration, up to 1 hour", 
    "castingTime": "1 Action", 
    "shortDescription": "Needs concentration. Transform a creature you can see into a new form. An unwilling creature must make a Wisdom save to avoid the effect. Does not effect shapechangers. The new form can be any beast whose challenge rating is equal to or less than the target's. The target's game stats are replaced by the new form's stats, yet retains its alignment and personality. It hit points assume the new form's. When it reverts to its normal form, its hit points return to that of its original form. If it reverts as a result of dropping to 0 hit points, any excess damage carries over to its normal form. The creature can't use an action that requires hands or speech.", 
  ...
  "banishment": {
    ...
    "duration": "Concentration, up to 1 minute", 
    "castingTime": "1 Action", 
    "shortDescription": "Needs concentration. You attempt to send one creature that you can see within range to another plane of existence. The target must succeed on a Charism save or be banished. If the target is native to the plane you're on, you banish it to a harmless demiplane, while there it is incapacitated. If the target is native to a different plane of existence it is banished to its home plane. When cast using 5th level or higher, you can target one additional creature for each slot above 4th.", 
  ...
  "dust devil": {
    ...
    "duration": "Concentration, up to 1 minute", 
    "castingTime": "1 Action", 
    "shortDescription": "Needs concentration. Choose an unoccupied 5ft cube within range. Any creature that ends its turn within 5ft of the dust devil must make a Strength save or take 1d8 bludgeoning damage and is pushed 10ft away, or take half on a save and isn't pushed. As a bonus action you can move the dust devil up to 30ft in any direction. When cast using a spell slot of 3rd level or higher, increase the damage by 1d8 for each level above 2nd.", 
  ...
  "arms of hadar": {
    ...
    "duration": "Instantaneous", 
    "castingTime": "1 Action", 
    "shortDescription": "Dark tendrils erupt from you and batter all creatures within 10ft of you. Each creature in that area must make a Strength save or take 2d6 necrotic damage, and can't take a reaction until its next turn. When cast using a spell slot of 2nd orr higher, increase the damage by 1d6 for each slot above 1st.", 
  ...
  "watery sphere": {
    ...
    "duration": "Concentration, up to 1 minute", 
    "castingTime": "1 Action", 
    "shortDescription": "Needs concentration. Conjure a 10ft radius sphere of water on a point within range. Any creature in the sphere's space must make a Strength save or be restrained and engulfed by the water. The sphere can restrain a maximum of 4 medium or smaller creatures, or one large creature. As an action you can move the sphere up to 30ft in a straight line.", 
  ...
  "divination ": {
    ...
    "longDescription": "Your magic and an offering put you in contact with a god or a god’s servants. You ask a single question concerning a specific goal, event, or activity to occur within 7 days. The D. M. offers a truthful reply. The reply might be a short phrase, a cryptic rhyme, or an omen. The spell doesn’t take into account any possible circumstances that might change the outcome, such as the casting of additional spells or the loss or gain of a companion. If you cast the spell two or more times before finishing your next long rest, there is a cumulative 25 percent chance for each casting after the first that you get a random reading. The D. M. makes this roll in secret."
  }, 
  "heroism": {
  ...
  "conjure elemental": {
    ...
    "longDescription": "You call forth an elemental servant. Choose an area of air, earth, fire, or water that fills a 10-foot cube within range. An elemental of challenge rating 5 or lower appropriate to the area you chose appears in an unoccupied space within 10 feet of it. For example, a fire elemental emerges from a bonfire, and an earth elemental rises up from the ground. The elemental disappears when it drops to 0 hit points or when the spell ends. The elemental is friendly to you and your companions for the duration. Roll initiative for the elemental, which has its own turns. It obeys any verbal commands that you issue to it (no action required by you). If you don’t issue any commands to the elemental, it defends itself from hostile creatures but otherwise takes no actions. If your concentration is broken, the elemental doesn’t disappear. Instead, you lose control of the elemental, it becomes hostile toward you and your companions, and it might attack. An uncontrolled elemental can’t be dismissed by you, and it disappears 1 hour after you summoned it. The D. M. has the elemental’s statistics. At Higher Levels: When you cast this spell using a spell slot of 6th level or higher, the challenge rating increases by 1 for each slot level above 5th."
  }, 
  "feign death ": {
  ...
  "holy aura": {
    ...
    "range": "Self", 
    "components": "Verbal, Somatic, Material (a tiny reliquary worth at least 1,000 gold pieces containing a sacred relic, such as a scrap of cloth from a saint's robe or a piece of parchment from a religious text)", 
    "spellType": "level 8 Abjuration", 
    "duration": "Concentration, up to 1 minute", 
    "castingTime": "1 Action", 
  ...
  "planar ally": {
    ...
    "longDescription": "You beseech an otherworldly entity for aid. The being must be known to you: a god, a primordial, a demon prince, or some other being of cosmic power. That entity sends a celestial, an elemental, or a fiend loyal to it to aid you, making the creature appear in an unoccupied space within range. If you know a specific creature’s name, you can speak that name when you cast this spell to request that creature, though you might get a different creature anyway (D. M.’s choice). When the creature appears, it is under no compulsion to behave in any particular way. You can ask the creature to perform a service in exchange for payment, but it isn’t obliged to do so. The requested task could range from simple (fly us across the chasm, or help us fight a battle) to complex (spy on our enemies, or protect us during our foray into the dungeon). You must be able to communicate with the creature to bargain for its services. Payment can take a variety of forms. A celestial might require a sizable donation of gold or magic items to an allied temple, while a fiend might demand a living sacrifice or a gift of treasure. Some creatures might exchange their service for a quest undertaken by you. As a rule of thumb, a task that can be measured in minutes requires a payment worth 100 gold pieces per minute. A task measured in hours requires 1,000 gold pieces per hour. And a task measured in days (up to 10 days) requires 10,000 gold pieces per day. The D. M. can adjust these payments based on the circumstances under which you cast the spell. If the task is aligned with the creature’s ethos, the payment might be halved or even waived. Nonhazardous tasks typically require only half the suggested payment, while especially dangerous tasks might require a greater gift. Creatures rarely accept tasks that seem suicidal. After the creature completes the task, or when the agreed-upon duration of service expires, the creature returns to its home plane after reporting back to you, if appropriate to the task and if possible. If you are unable to agree on a price for the creature’s service, the creature immediately returns to its home plane. A creature enlisted to join your group counts as a member of it, receiving a full share of experience points awarded."
  }, 
  "lightning lure": {
  ...
  "command": {
    ...
    "longDescription": "You speak a one-word command to a creature you can see within range. The target must succeed on a Wisdom saving throw or follow the command on its next turn. The spell has no effect if the target is undead, if it doesn’t understand your language, or if your command is directly harmful to it. Some typical commands and their effects follow. You might issue a command other than one described here. Ifyou do so, the D. M. determines how the target behaves. If the target can’t follow your command, the spell ends. Approach. The target moves toward you by the shortest and most direct route, ending its turn if it moves within 5 feet of you. Drop. The target drops whatever it is holding and then ends its turn. Flee. The target spends its turn moving away from you by the fastest available means. Grovel. The target falls prone and then ends its turn. Halt. The target doesn’t move and takes no actions. A flying creature stays aloft, provided that it is able to do so. If it must move to stay aloft, it flies the minimum distance needed to remain in the air. At Higher Levels: When you cast this spell using a spell slot of 2nd level or higher, you can affect one additional creature for each slot level above 1st. The creatures must be within 30 feet of each other when you target them."
  }, 
  "fog cloud": {
