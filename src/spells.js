  module.exports = {     
   ...
   "SPELLS" : {
    ...
    "prismatic spray": {
      ...
      "damage"            : "10d6 elemental damage base on dice roll, please ask for short description if you need more information"
    },
    "frostbite": {
      "castingTime"       : "1 Action",
      "duration"          : "Instantaneous",
    ...
    "prismatic wall": {
      ...
      "damage"            : "10d6 elemental damage based on wall level, please ask for the short or long description for more information"
    },
    "shapechange": {
      "castingTime"       : "1 Action",
      "duration"          : "Concentration, up to 1 hour",
    ...
    "ice storm": {
      ...
      "damage"            : "2d8 bludgeoning damage and 4d6 cold damage"
    },
    "flame arrows": {
      "castingTime"       : "1 Action",
      "duration"          : "Concentration, up to 1 hour",
    ...
    "fire shield": {
      ...
      "damage"            : "2d8 fire or cold damage depending on elemental type of shield."
    },
    "darkness": {
      "castingTime"       : "1 Action",
      "duration"          : "Concentration, up to 10 minutes",
    ...
    "spirit guardians": {
      ...
      "damage"            : "3d8 radiant or necrotic damage based on your alignment"
    },
    "reincarnate": {
      "castingTime"       : "1 Hour",
      "duration"          : "Instantaneous",
    ...
    "investiture of flame": {
      ...
      "damage"            : "1d10 fire damage for creature proximinty and 4d8 fire damage for wall effect. Ask for short or long description for more information"
    },
    "magic mouth": {
      "castingTime"       : "1 Minute",
      "duration"          : "Until dispelled",
    ...
    "wall of thorns": {
      ...
      "damage"            : "7d8 peircing damage creatures caught in the area when cast. 7d8 slashing if the creature enters the wall area"
    },
    "wall of force": {
      "castingTime"       : "1 Action",
      "duration"          : "Concentration, up to 10 minutes",
    ...
    "melf's acid arrow": {
      ...
      "damage"            : "4d4 acid damage immediately and 2d4 acid damage at the end of next turn"
    },
    "feather fall": {
      "castingTime"       : "Special",
      "duration"          : "1 minute",
    ...
    "vitriolic sphere": {
      ...
      "damage"            : "10d4 acid damage and 5d4 acid damage"
    },
    "haste": {
      "castingTime"       : "1 Action",
      "duration"          : "Concentration, up to 1 minute",
    ...
    "enlarge/reduce": {
      ...
      "damage"            : "1d4 extra damage if enlarged and 1d4 less damage is reduced"
    },
    "rope trick": {
      "castingTime"       : "1 Action",
      "duration"          : "1 hour",
    ...
    "tsunami": {
      ...
      "damage"            : "6d10 bludgeoning when the wave first hits and 1d10 less per turn"
    },
    "incendiary cloud": {
      "castingTime"       : "1 Action",
      "duration"          : "Concentration, up to 1 minute",
    ...
    "storm sphere": {
      ...
      "damage"            : "2d6 bludgeoning damage when the spell is cast and for creatures in the area affect. And once per turn cast 4d6 lightning damage on one creature in area affect"
    },
    "hunter's mark": {
      "castingTime"       : "1 Bonus Action",
      "duration"          : "Concentration, up to 1 hour",
    ...
    "control water": {
      ...
      "spellType"         : "level 4 Transmutation",
      "shortDescription"  : "Requires concentration. Control a 100 foot cube of freestanding water in a few ways. You can raise the water level up to 20ft, or make a trench that slowly fills in over the next round, redirect the flow, or create a whirlpool that restrains creatures on a failed Athletics check. Creatures in the whrlpool take 2d8 bludgeoning damage for each round on the fail, and half as much on a save.",
    ...
    "ice knife": {
      ...
      "damage"            : "1d10 piercing damage on taarget and 2d6 cold damage for creatures within five feet of target"
    },
    "revivify": {
      "castingTime"       : "1 Action",
      "duration"          : "Instantaneous",
    ...
    "immolation": {
      ...
      "damage"            : "7d6 fire damage when first cast and 3d6 fire damage on subsequent turns"
    },
    "sequester": {
      "castingTime"       : "1 Action",
      "duration"          : "Until dispelled",
    ...
    "wall of ice": {
      ...
      "damage"            : "10d6 cold damage for creatures caught in the wall when cast then 5d6 cold damage when wall is desroyed and creatures pass through the icy veil left behind"
    },
    "animal messenger ": {
      "castingTime"       : "1 Action",
      "duration"          : "24 hours",
    ...
    "lightning arrow": {
      ...
      "damage"            : "4d8 lightning damage on taget and 2d8 lightning damage for creatures in a 10 foot radius"
    },
    "magic stone": {
      "castingTime"       : "1 Bonus Action",
      "duration"          : "1 minute",
    ...
    "investiture of wind": {
      ...
      "damage"            : "2d10 bludgeoning damage"
    },
    "eldritch blast": {
      "castingTime"       : "1 Action",
      "duration"          : "Instantaneous",
    ...
    "hunger of hadar": {
      ...
      "damage"            : "2d6 cold damage if creature starts their turn in area and 2d6 acid damage at the end of their turn on a failed Dexterity save"
    },
    "elemental bane": {
      "castingTime"       : "1 Action",
      "duration"          : "Concentration, up to 1 minute",
    ...
    "flame strike": {
      ...
      "damage"            : "4d6 fire damage and 4d6 radiant damage"
    },
    "cloud of daggers": {
      "castingTime"       : "1 Action",
      "duration"          : "Concentration, up to 1 minute",
    ...
    "storm of vengeance": {
      ...
      "damage"            : "complex damage type listen to short or long description"
    },
    "find traps": {
      "castingTime"       : "1 Action",
      "duration"          : "Instantaneous",
