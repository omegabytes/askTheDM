...
function Cleric(prof_bon, char_mod, con_mod){
	...
	//class_desc
	this.short_description = char_classes.cleric.class_description.shortDesc;
	this.long_description = char_classes.cleric.class_description.longDesc;
